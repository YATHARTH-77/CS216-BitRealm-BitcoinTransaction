...
<!-- Header Banner -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=200&section=header&text=CS216%20%E2%80%94%20Bitcoin%20Transaction%20Lab&fontSize=36&fontColor=fff&animation=fadeIn&fontAlignY=38&desc=Legacy%20%26%20SegWit%20Transactions%20on%20Regtest&descAlignY=60&descAlign=50" width="100%"/>

<br/>

<!-- Badges Row 1 -->
[![Course](https://img.shields.io/badge/Course-CS216%20Intro%20to%20Blockchains-orange?style=for-the-badge&logo=bitcoin&logoColor=white)](.)
[![Team](https://img.shields.io/badge/Team-BitRealm-blueviolet?style=for-the-badge&logo=github&logoColor=white)](.)
[![Network](https://img.shields.io/badge/Network-Regtest-blue?style=for-the-badge&logo=linux&logoColor=white)](.)

<!-- Badges Row 2 -->
[![Bitcoin Core](https://img.shields.io/badge/Bitcoin%20Core-v28.1+-F7931A?style=for-the-badge&logo=bitcoin&logoColor=white)](https://bitcoin.org/en/download)
[![Python](https://img.shields.io/badge/Python-3.8+-3776AB?style=for-the-badge&logo=python&logoColor=white)](https://www.python.org/)
[![Platform](https://img.shields.io/badge/Platform-WSL%20%2F%20Linux-E95420?style=for-the-badge&logo=ubuntu&logoColor=white)](.)
...
|:----:|:---------------:|:------------:|----------|
| **🔴 Part 1** | **Legacy** | `P2PKH` (`legacy`) | Signature is embedded **inside** the transaction (`scriptSig`), contributing to total size. |
| **🟢 Part 2** | **SegWit** | `P2SH-P2WPKH` (`p2sh-segwit`) | Witness data (signatures) is moved **outside** the main transaction body, reducing virtual size (`vsize`). |
...
│                         EXECUTION PIPELINE                              │
├───────────┬──────────────────────────────────────────────────────────── │
│  Step 1   │  🏦  Wallet Setup — Creates/loads wallet named lab_wallet   │
│  Step 2   │  ⛏️  Mining   — Mines 101 blocks (coinbase becomes spendable)│
│  Step 3   │  🔴  Legacy   — A → B → C  (P2PKH chain, 0.999 / 0.998 BTC)│
│  Step 4   │  🟢  SegWit   — A'→ B'→ C' (P2SH-P2WPKH chain)             │
│  Step 5   │  💾  Export   — Saves raw hex to legacy.hex & segwit.hex    │
└───────────┴──────────────────────────────────────────────────────────── ┘
```
...
|-----------|---------|---------|
| ![Bitcoin](https://img.shields.io/badge/-Bitcoin%20Core-F7931A?logo=bitcoin&logoColor=white) **`bitcoind`** | Local regtest node | [bitcoin.org/en/download](https://bitcoin.org/en/download) |
| ![Python](https://img.shields.io/badge/-Python%203.8+-3776AB?logo=python&logoColor=white) | Script runtime | [python.org](https://www.python.org/downloads/) |
| ![PyPI](https://img.shields.io/badge/-python--bitcoinrpc-3775A9?logo=pypi&logoColor=white) | JSON-RPC client for `bitcoind` | `pip install python-bitcoinrpc` |
...
### ▶️ Step 2 — Start the Regtest Node
...
> **⏱️ Note:** Wait about 5–10 seconds for the node to fully wake up. You can verify it is running by checking the block count:
> ```bash
...
1. ⛏️ Mines 101 blocks to fund a local testing wallet.
...
| **💰 Fee Efficiency** | Baseline | **~30% cheaper** |
...
*Built with ₿ for CS216 · Team BitRealm*
